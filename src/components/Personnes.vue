...
<div class="m-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 display: inline-block">
    ...
    <div class="flex flex-col p-5">
        <h4 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">{{ person.civility_id }}</h4>
        <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">{{ person.last_name }} {{ person.first_name }}</h5>
...
<script setup>
    ...
    const { getPersonne, person } = usePersonnes();
